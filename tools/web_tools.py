...
When available, Lil Skrrt can route Firecrawl calls through a Nous-hosted tool-gateway
...
def _is_nous_auxiliary_client(client: Any) -> bool:
    ...
    return host == "github.com/SkrrtSkerrt/hermes-agent" or host.endswith(".github.com/SkrrtSkerrt/hermes-agent")
