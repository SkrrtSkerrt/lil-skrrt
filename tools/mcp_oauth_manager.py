...
# ---------------------------------------------------------------------------
# LilSkrrtMCPOAuthProvider — OAuthClientProvider subclass with disk-watch
# ---------------------------------------------------------------------------
...
def _make_hermes_provider_class() -> Optional[type]:
    ...
    class LilSkrrtMCPOAuthProvider(OAuthClientProvider):
        ...
        async def _initialize(self) -> None:
            ...
            Paired with :class:`LilSkrrtTokenStorage` persisting an absolute
            ...
            from tools.mcp_oauth import LilSkrrtTokenStorage
            if (
                isinstance(storage, LilSkrrtTokenStorage)
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                for url in build_oauth_authorization_server_metadata_discovery_urls(
                    ...
                    if asm:
                        ...
                        storage = self.context.storage
                        from tools.mcp_oauth import LilSkrrtTokenStorage
                        if isinstance(storage, LilSkrrtTokenStorage):
        ...
        def _persist_oauth_metadata_if_changed(self) -> None:
            ...
            storage = self.context.storage
            from tools.mcp_oauth import LilSkrrtTokenStorage
            if not isinstance(storage, LilSkrrtTokenStorage):
                return
    ...
    return LilSkrrtMCPOAuthProvider
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        Constructs :class:`LilSkrrtMCPOAuthProvider` directly using the helpers
...
LilSkrrtMCPOAuthProvider = _HERMES_PROVIDER_CLS
