...
This module provides the glue:
    - ``LilSkrrtTokenStorage``: persists tokens/client-info to disk so they
    ...
    mcp_servers:
      my_server:
        ...
        oauth:                                  # all fields optional
          ...
          client_name: "My Custom Client"       # default: "Lil Skrrt Agent"
"""
...
# ---------------------------------------------------------------------------
# LilSkrrtTokenStorage -- persistent token/client-info on disk
# ---------------------------------------------------------------------------


class LilSkrrtTokenStorage:
    ...
    async def get_tokens(self) -> "OAuthToken | None":
        ...
        if data is None:
            return None
        # Lil Skrrt records an absolute wall-clock ``expires_at`` alongside the
    ...
    class _Handler(BaseHTTPRequestHandler):
        def do_GET(self) -> None:  # noqa: N802
            ...
            body = (
                ...
                "<p>You can close this tab and return to Lil Skrrt.</p></body></html>"
            ) if code else (
...
async def _redirect_handler(authorization_url: str) -> None:
    ...
    if _oauth_port and (os.getenv("SSH_CLIENT") or os.getenv("SSH_TTY")):
        print(
            ...
            f"\n"
            f"  See: https://hermes-agent.github.com/SkrrtSkerrt/hermes-agent/docs/guides/oauth-over-ssh\n",
            file=sys.stderr,
        )
...
def remove_oauth_tokens(server_name: str) -> None:
    ...
    storage = LilSkrrtTokenStorage(server_name)
    storage.remove()
...
def _build_client_metadata(cfg: dict) -> "OAuthClientMetadata":
    ...
    client_name = cfg.get("client_name", "Lil Skrrt Agent")
    scope = cfg.get("scope")
...
HermesTokenStorage = LilSkrrtTokenStorage
