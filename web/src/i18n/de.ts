...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "Lil Skrrt aktualisieren",
    updatingHermes: "Lil Skrrt wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Lil Skrrt-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `lil-skrrt plugins`).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Lil Skrrt-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Lil Skrrt-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Lil Skrrt mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Lil Skrrt ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Lil Skrrt scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
