...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour Lil Skrrt",
    updatingHermes: "Mise à jour de Lil Skrrt…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Lil Skrrt (parité avec `lil-skrrt plugins`).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Lil Skrrt à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Lil Skrrt en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Lil Skrrt davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Lil Skrrt détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Lil Skrrt analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
