...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Lil Skrrt",
    updatingHermes: "Updating Lil Skrrt…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Lil Skrrt plugins (`lil-skrrt plugins` parity).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Lil Skrrt badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Lil Skrrt session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Lil Skrrt more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Lil Skrrt sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Lil Skrrt is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
