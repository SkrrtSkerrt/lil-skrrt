...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateHermes: "Lil Skrrt frissítése",
    updatingHermes: "Lil Skrrt frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Lil Skrrt-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `lil-skrrt plugins` paritás).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Lil Skrrt-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Lil Skrrt munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Lil Skrrtt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Lil Skrrt kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Lil Skrrt egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
