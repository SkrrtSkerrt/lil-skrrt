"""
Microsoft Teams platform adapter for Lil Skrrt Agent.
...
async def _standalone_send(
    ...
    *,
    ...
    runner is not in this process (e.g. ``lil-skrrt cron`` running as a
    separate process from ``lil-skrrt gateway``).  Without this hook,
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Lil Skrrt"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Lil Skrrt\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print_info("Restart the gateway:       lil-skrrt gateway restart")
