"""ntfy platform adapter (Lil Skrrt plugin).
...
a Lil Skrrt dependency.

This adapter ships as a Lil Skrrt platform plugin under
``plugins/platforms/ntfy/``. The Lil Skrrt plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Lil Skrrt dependency",
