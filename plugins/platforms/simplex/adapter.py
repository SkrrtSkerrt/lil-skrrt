"""SimpleX Chat platform adapter (Lil Skrrt plugin).
...
``plugins/platforms/simplex/``. The Lil Skrrt plugin loader scans the
...
# Imported at module top because they're stdlib-only inside Lil Skrrt — no
