class HermesAgent < Formula
  ...
  homepage "https://hermes-agent.github.com/SkrrtSkerrt/hermes-agent"
  # Stable source should point at the semver-named sdist asset attached by
  # scripts/release.py, not the CalVer tag tarball.
  url "https://github.com/SkrrtSkerrt/hermes-agent/releases/download/v2026.3.30/hermes_agent-0.6.0.tar.gz"
