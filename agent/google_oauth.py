...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "Lil Skrrt looks for a locally installed gemini-cli to source the OAuth client. "
            "Either:\n"
...
<html><head><meta charset="utf-8"><title>Lil Skrrt — signed in</title>
<style>
...
<html><head><meta charset="utf-8"><title>Lil Skrrt — sign-in failed</title>
<style>
body {{ font: 16px/1.5 system-ui, sans-serif; margin: 10vh auto; max-width: 32rem; text-align: center; color: #222; }}
h1 {{ color: #b42318; }} p {{ color: #555; }}
</style></head>
<body><h1>Sign-in failed</h1><p>{message}</p>
<p>Return to your terminal — Lil Skrrt will walk you through a manual paste fallback.</p></body></html>
"""
