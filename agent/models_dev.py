...
# ---------------------------------------------------------------------------
# Provider ID mapping: Lil Skrrt ↔ models.dev
# ---------------------------------------------------------------------------

# Lil Skrrt provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Lil Skrrt (built lazily)
...
def _provider_models_dev_ids(provider: str) -> list[str]:
    """Return candidate models.dev provider IDs for a Lil Skrrt provider.
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Lil Skrrt provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Lil Skrrt agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Lil Skrrt provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Lil Skrrt ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Lil Skrrt or models.dev provider ID.  Tries exact match then
