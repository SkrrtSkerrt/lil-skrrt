        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    print(f"{agent.log_prefix}     • Check credits / billing: https://portal.github.com/SkrrtSkerrt/hermes-agent")
                    ...
                    if classified.is_auth or classified.reason == FailoverReason.billing:
                        if _provider in {"openai-codex", "xai-oauth", "nous"} and status_code == 401:
                            if _provider == "openai-codex":
                                ...
                                agent._vprint(f"{agent.log_prefix}      2. Check your portal account: https://portal.github.com/SkrrtSkerrt/hermes-agent", force=True)
