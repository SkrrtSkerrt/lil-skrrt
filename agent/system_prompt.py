...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Lil Skrrt never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Lil Skrrt itself.
    ...
    # Active-profile hint — names the Lil Skrrt profile the agent is running
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Lil Skrrt never rebuilds or reinjects parts of it
