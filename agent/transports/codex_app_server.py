...
projection into Lil Skrrt' display, approval bridging, transcript projection into
...
"codex_app_server"`. Lil Skrrt' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def initialize(
        ...
        client_title: str = "Lil Skrrt Agent",
