...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Lil Skrrt/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Lil Skrrt'
    ...
    # is stricter (low/high). Clamp Lil Skrrt' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Lil Skrrt-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Lil Skrrt-internal scaffolding markers (``_``-prefixed).
