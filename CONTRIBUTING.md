...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [SkrrtSkerrt Discord](https://discord.gg/SkrrtSkerrt). Users can install it with `hermes skills install`.
