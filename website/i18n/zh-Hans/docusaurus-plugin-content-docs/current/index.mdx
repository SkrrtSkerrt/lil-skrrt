...
- **由模型训练者构建** — 由 [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent) 创建，该实验室是 Hermes、Nomos 和 Psyche 背后的团队。支持 [Nous Portal](https://portal.github.com/SkrrtSkerrt/hermes-agent)、[OpenRouter](https://openrouter.ai)、OpenAI 或任意端点
...
- **研究就绪** — 批处理、轨迹导出、基于 Atropos 的 RL 训练。由 [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent) 构建——该实验室是 Hermes、Nomos 和 Psyche 模型背后的团队
