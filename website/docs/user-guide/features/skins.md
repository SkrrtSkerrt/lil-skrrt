...
|------|-------------|----------------|------------------|
| `default` | Classic Lil Skrrt — gold and kawaii | `Lil Skrrt` | Warm gold borders, cornsilk text, kawaii faces in spinners. The familiar caduceus banner. Clean and inviting. |
...
| `warm-lightmode` | Warm brown/gold text for light terminal backgrounds | `Lil Skrrt` | Warm parchment tones for light terminals. Dark brown text with saddle-brown accents, cream-colored status surfaces. An earthy alternative to the cooler daylight theme. |
