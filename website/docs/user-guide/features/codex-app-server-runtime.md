...
If you find a bug, [open an issue](https://github.com/SkrrtSkerrt/hermes-agent/issues) with the output of `hermes logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
