...
Type `@` followed by a reference to inject content directly into your message. Lil Skrrt expands the reference inline and appends the content under an `--- Attached Context ---` section.
