...
Control the user's Spotify account via the Lil Skrrt Spotify toolset (7 tools). Setup guide: https://hermes-agent.github.com/SkrrtSkerrt/hermes-agent/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `lil-skrrt auth spotify` again.
