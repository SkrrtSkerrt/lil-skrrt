...
| Version | `1.0.0` |
| Author | Lil Skrrt + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
Each template includes a **Lil Skrrt Implementation Notes** block at the top with:
