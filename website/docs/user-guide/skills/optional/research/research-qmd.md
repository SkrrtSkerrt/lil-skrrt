...
| | |
|---|---|
| Source | Optional — install with `lil-skrrt skills install official/research/qmd` |
...
Lil Skrrt via the native MCP client. This is the preferred
...
Then configure Lil Skrrt to connect via HTTP:
