...
| | |
|---|---|
| Source | Optional — install with `lil-skrrt skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Lil Skrrt (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
