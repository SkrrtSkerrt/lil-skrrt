...
| | |
|---|---|
| Source | Optional — install with `lil-skrrt skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Lil Skrrt |
| License | MIT |
...
import upstream classes into Lil Skrrt itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Lil Skrrt core.
