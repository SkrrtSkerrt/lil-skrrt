...
- User wants **Lil Skrrt itself to drive a browser** → use Lil Skrrt' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
