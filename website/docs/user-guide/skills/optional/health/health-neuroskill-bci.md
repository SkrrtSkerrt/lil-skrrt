...
| | |
|---|---|
| Source | Optional — install with `lil-skrrt skills install official/health/neuroskill-bci` |
...
Connect Lil Skrrt to a running [NeuroSkill](https://neuroskill.com/) instance to read
