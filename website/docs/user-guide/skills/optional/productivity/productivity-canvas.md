...
| | |
|---|---|
| Source | Optional — install with `lil-skrrt skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Lil Skrrt"), set an optional expiry, and click **Generate Token**
