...
* Implementation: [`agent/plugin_llm.py`](https://github.com/SkrrtSkerrt/hermes-agent/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/SkrrtSkerrt/hermes-agent/blob/main/tests/agent/test_plugin_llm.py)
* Reference plugins (companion repo):
  * [`plugin-llm-example`](https://github.com/SkrrtSkerrt/hermes-example-plugins/tree/main/plugin-llm-example) — sync structured extraction with image input
  * [`plugin-llm-async-example`](https://github.com/SkrrtSkerrt/hermes-example-plugins/tree/main/plugin-llm-async-example) — async with `asyncio.gather()`
