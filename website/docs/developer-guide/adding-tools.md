...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Lil Skrrt — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Lil Skrrt tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Lil Skrrt core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Lil Skrrt Plugin](/guides/build-a-hermes-plugin)
...
- [ ] Tested with `lil-skrrt chat -q "Use the weather tool for London"`
