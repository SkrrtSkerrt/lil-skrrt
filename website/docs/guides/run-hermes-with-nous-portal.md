...
Open [portal.github.com/SkrrtSkerrt/hermes-agent/manage-subscription](https://portal.github.com/SkrrtSkerrt/hermes-agent/manage-subscription), sign up, and pick a plan.
...
If a model is genuinely unavailable, [open an issue](https://github.com/SkrrtSkerrt/hermes-agent/issues) — most gaps are routing config we can update.
