---
sidebar_position: 8
title: "Use Voice Mode with Lil Skrrt"
description: "A practical guide to setting up and using Lil Skrrt voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Lil Skrrt
...
- you want Lil Skrrt sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Lil Skrrt.
...
## Step 1: make sure normal Lil Skrrt works first
...
Lil Skrrt supports both local and cloud speech stacks.
...
4. Lil Skrrt transcribes and responds
...
- asking Lil Skrrt to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Lil Skrrt loop.

## Tuning CLI behavior

### Silence threshold

If Lil Skrrt starts/stops too aggressively, tune:
...
Lil Skrrt stays a normal chat bot, but can speak replies.
...
- you want Lil Skrrt to function like a portable research or ops assistant
...
Lil Skrrt joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Lil Skrrt detects speech boundaries
- transcripts are posted in the associated text channel
- Lil Skrrt responds in text and audio
