...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Lil Skrrt documentation based on your experience level and goals.'
---

# Learning Path

Lil Skrrt can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Lil Skrrt yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Lil Skrrt can do.
...
Use Lil Skrrt as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Lil Skrrt can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Lil Skrrt as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Lil Skrrt](/guides/use-voice-mode-with-hermes)
...
:::tip
Cron jobs let Lil Skrrt run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Lil Skrrt with your own tools and reusable skill packages.

1. [Plugins](/user-guide/features/plugins)
2. [Build a Lil Skrrt Plugin](/guides/build-a-hermes-plugin)
...
page is for built-in Lil Skrrt core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Lil Skrrt's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Lil Skrrt handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Lil Skrrt into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Lil Skrrt tools programmatically | [Code Execution](/user-guide/features/code-execution) |
