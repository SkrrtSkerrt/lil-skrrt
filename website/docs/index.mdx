...
slug: /
sidebar_position: 0
title: "Lil Skrrt Documentation"
description: "The self-improving AI agent built by SkrrtSkerrt. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [SkrrtSkerrt](https://github.com/SkrrtSkerrt). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.

<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  <Link to="/getting-started/installation" style={{display: 'inline-block', padding: '0.6rem 1.2rem', backgroundColor: '#38BDF8', color: '#0F172A', borderRadius: '8px', fontWeight: 600, textDecoration: 'none'}}>Get Started →</Link>
  <a href="https://github.com/SkrrtSkerrt/lil-skrrt" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(56,189,248,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Lil Skrrt safely |
| 🧭 **[Use MCP with Lil Skrrt](/guides/use-mcp-with-hermes)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Lil Skrrt](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Hermes voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Lil Skrrt's default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Lil Skrrt |
...
- **Built by model trainers** — Created by [SkrrtSkerrt](https://github.com/SkrrtSkerrt), the team behind Lil Skrrt. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [SkrrtSkerrt](https://github.com/SkrrtSkerrt) — the team behind Lil Skrrt models
