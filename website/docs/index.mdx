...
The self-improving AI agent built by [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/SkrrtSkerrt/hermes-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🗣️ **[Use Voice Mode with Lil Skrrt](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Lil Skrrt voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Lil Skrrt' default voice with a global SOUL.md |
...
- **Built by model trainers** — Created by [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent), the lab behind Lil Skrrt, Nomos, and Psyche. Works with [Nous Portal](https://portal.github.com/SkrrtSkerrt/hermes-agent), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent) — the lab behind Lil Skrrt, Nomos, and Psyche models
