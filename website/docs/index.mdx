...
- **Built by model trainers** — Created by [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.github.com/SkrrtSkerrt/hermes-agent), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [SkrrtSkerrt](https://github.com/SkrrtSkerrt/hermes-agent) — the lab behind Hermes, Nomos, and Psyche models
