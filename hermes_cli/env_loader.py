"""Helpers for loading Lil Skrrt .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    already knows all valid Lil Skrrt env-var names and can split
...
def load_hermes_dotenv(
    *,
    ...
    """Load Lil Skrrt environment files with user config taking precedence.
...
def _apply_external_secret_sources(home_path: Path) -> None:
    ...
    locate the access token) but BEFORE the rest of Lil Skrrt reads
