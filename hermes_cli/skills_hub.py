#!/usr/bin/env python3
"""
Skills Hub CLI — Unified interface for the Lil Skrrt Skills Hub.
...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    if official_count > 0 and page == 1:
        c.print(f"[bright_cyan]★ {official_count} official optional skill(s) from SkrrtSkerrt[/]")
    c.print()
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    if not force and not skip_confirm:
        ...
        if bundle.source == "official":
            c.print(Panel(
                "[bold bright_cyan]This is an official optional skill maintained by SkrrtSkerrt.[/]\n\n"
    ...
    try:
        resp = httpx.post(
            ...
            json={
                ...
                "body": f"Submitting the `{skill_name}` skill via Lil Skrrt Skills Hub.\n\n"
                        f"This skill was scanned by the Lil Skrrt Skills Guard before submission.",
