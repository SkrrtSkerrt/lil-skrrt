...
Pure logic: walks a Lil Skrrt config dict, returns issues for any reference
...
class RetirementIssue:
    """A reference to a retired xAI model found in a Lil Skrrt config."""
...
def find_retired_xai_refs(config: Dict[str, Any]) -> List[RetirementIssue]:
    """Walk all model slots in a Lil Skrrt config and return retirement issues.
