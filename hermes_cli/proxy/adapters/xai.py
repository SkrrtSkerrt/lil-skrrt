...
# xAI's public API is OpenAI-compatible for the endpoints Lil Skrrt commonly
# uses. The Responses endpoint is included because Lil Skrrt' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Lil Skrrt-managed OAuth credentials."""
