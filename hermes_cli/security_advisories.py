"""
Security advisory checker for Lil Skrrt Agent.
...
run in environments where the rest of Lil Skrrt failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Lil Skrrt requires 3.10+ but defensive.
        return None
    try:
