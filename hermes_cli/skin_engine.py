"""Lil Skrrt CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Lil Skrrt"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ☠︎"              # Shown on exit
      response_label: " ☠︎ Lil Skrrt "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Lil Skrrt"
...
def get_active_goodbye(fallback: str = "Goodbye! ☠︎") -> str:
