...
TIPS = [
    ...
    "Ctrl+Z suspends Lil Skrrt to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Lil Skrrt itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Lil Skrrt home directory.",
    ...
    "hermes gateway install sets up Lil Skrrt as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Lil Skrrt tools programmatically — results stay out of context.",
    ...
    "When exiting, Lil Skrrt prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Lil Skrrt runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Lil Skrrt via a local macOS server.",
    ...
    "Lil Skrrt loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Lil Skrrt as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Lil Skrrt your own.",
    ...
    "Before a gateway session reset, Lil Skrrt auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Lil Skrrt auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Lil Skrrt config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Lil Skrrt is working.',
    ...
    'hermes dashboard --tui embeds the full Lil Skrrt TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Lil Skrrt block commands when the tirith scanner itself errors out.',
