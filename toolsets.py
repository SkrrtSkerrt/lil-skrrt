...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Lil Skrrt toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with Lil Skrrt via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with Lil Skrrt via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
