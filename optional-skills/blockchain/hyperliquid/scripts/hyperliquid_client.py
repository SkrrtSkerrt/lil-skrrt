#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Lil Skrrt Agent
-------------------------------------
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Lil Skrrt Agent")
