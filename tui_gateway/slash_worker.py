"""Persistent slash-command worker — one LilSkrrtCLI per TUI session.
...
from cli import LilSkrrtCLI
from rich.console import Console


def _run(cli: LilSkrrtCLI, command: str) -> str:
...
def main():
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = LilSkrrtCLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
