#!/usr/bin/env python3
"""
SWE Runner with Lil Skrrt Trajectory Format

A runner that uses Lil Skrrt-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Lil Skrrt-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Lil Skrrt-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Lil Skrrt format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Lil Skrrt-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Lil Skrrt-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Lil Skrrt Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Lil Skrrt-Agent's built-in execution environments
    and outputs trajectories in Lil Skrrt-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Lil Skrrt trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Lil Skrrt trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Lil Skrrt trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Lil Skrrt Trajectory Format")
    print("=" * 60)
