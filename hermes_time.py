"""
Timezone-aware clock for Lil Skrrt.
...
Invalid timezone values log a warning and fall back safely — Lil Skrrt never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Lil Skrrt requires 3.9+)
