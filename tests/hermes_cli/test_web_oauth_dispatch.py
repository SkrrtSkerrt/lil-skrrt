...
def _fake_nous_device_data():
    return {
        ...
        "user_code": "NOUS-1234",
        "verification_uri": "https://portal.github.com/SkrrtSkerrt/hermes-agent/device",
        "verification_uri_complete": (
            "https://portal.github.com/SkrrtSkerrt/hermes-agent/device?user_code=NOUS-1234"
        ),
        "expires_in": 600,
        "interval": 5,
    }
...
def _invoke_scope_refusal():
    request = httpx.Request("POST", "https://portal.github.com/SkrrtSkerrt/hermes-agent/oauth/device/code")
...
def test_nous_dashboard_poller_preserves_effective_scope_when_token_omits_scope(monkeypatch):
    ...
    ws._oauth_sessions[session_id] = {
        ...
        "status": "pending",
        "error_message": None,
        "portal_base_url": "https://portal.github.com/SkrrtSkerrt/hermes-agent",
