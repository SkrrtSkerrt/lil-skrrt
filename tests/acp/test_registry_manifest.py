...
def test_agent_json_matches_official_registry_required_fields():
    ...
    assert data["name"] == "Lil Skrrt"
    assert data["description"]
    assert data["repository"] == "https://github.com/SkrrtSkerrt/hermes-agent"
    assert data["website"].startswith("https://hermes-agent.github.com/SkrrtSkerrt/hermes-agent/")
    assert data["authors"] == ["SkrrtSkerrt"]
