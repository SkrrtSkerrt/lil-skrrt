...
def test_resolve_managed_tool_gateway_derives_vendor_origin_from_shared_domain():
    ...
    assert result.gateway_origin == "https://firecrawl-gateway.github.com/SkrrtSkerrt/hermes-agent"
...
def test_resolve_managed_tool_gateway_is_disabled_without_subscription():
    with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "github.com/SkrrtSkerrt/hermes-agent"}, clear=False), \
