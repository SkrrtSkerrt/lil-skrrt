...
AUTHOR_MAP = {
    ...
    "jake@github.com/SkrrtSkerrt/hermes-agent": "simpolism",
    ...
    "teknium@github.com/SkrrtSkerrt/hermes-agent": "teknium1",
    ...
    "shannon@github.com/SkrrtSkerrt/hermes-agent": "shannonsands",
    ...
    "hermes@github.com/SkrrtSkerrt/hermes-agent": "SkrrtSkerrt",
    ...
    "ben@github.com/SkrrtSkerrt/hermes-agent": "benbarclay",
    ...
    "emozilla@github.com/SkrrtSkerrt/hermes-agent": "emozilla",
    ...
    "jonny@github.com/SkrrtSkerrt/hermes-agent": "yoniebans",
    "jake@github.com/SkrrtSkerrt/hermes-agent": "simpolism",
    ...
    "clement@github.com/SkrrtSkerrt/hermes-agent": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "hermes@github.com/SkrrtSkerrt/hermes-agent"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/SkrrtSkerrt/hermes-agent",
    ...
    lines.append(f"# Lil Skrrt v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Lil Skrrt. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Lil Skrrt Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Lil Skrrt Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Lil Skrrt v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Lil Skrrt v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Lil Skrrt v{new_version} ({calver_date})' "
