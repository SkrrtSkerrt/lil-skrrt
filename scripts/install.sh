...
# Configuration
REPO_URL_SSH="git@github.com:SkrrtSkerrt/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/SkrrtSkerrt/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/SkrrtSkerrt/hermes-agent/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
