#!/usr/bin/env python3
"""Build the Lil Skrrt Model Catalog — a centralized JSON manifest of curated models.
...
Lil Skrrt CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Lil Skrrt release.
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://hermes-agent.github.com/SkrrtSkerrt/hermes-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
