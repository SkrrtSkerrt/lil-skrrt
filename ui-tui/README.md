...
React + Ink terminal UI for Lil Skrrt. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
tui_gateway/
  ...
  slash_worker.py        persistent Lil Skrrt CLI subprocess for slash commands
```
