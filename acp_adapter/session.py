"""ACP session manager — maps ACP sessions to Lil Skrrt AIAgent instances.
...
def _translate_acp_cwd(cwd: str) -> str:
    """Translate Windows ACP cwd values when Lil Skrrt itself is running in WSL.
...
def _register_task_cwd(task_id: str, cwd: str) -> None:
    ...
    Zed can launch Lil Skrrt from a Windows workspace while the ACP process runs
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed Lil Skrrt agent."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by Lil Skrrt AIAgent instances.
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            agent_factory: Optional callable that creates an AIAgent-like object.
                           ...
                           using the current Lil Skrrt runtime provider configuration.
