...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="hermes-acp",
        description="Run Lil Skrrt as an ACP stdio server.",
    )
    parser.add_argument("--version", action="store_true", help="Print Lil Skrrt version and exit")
    parser.add_argument(
        "--check",
        action="store_true",
...
def _run_check() -> None:
    ...
    from acp_adapter.server import LilSkrrtACPAgent  # noqa: F401

    print("Lil Skrrt ACP check OK")
...
def main(argv: list[str] | None = None) -> None:
    ...
    import acp
    from .server import LilSkrrtACPAgent
