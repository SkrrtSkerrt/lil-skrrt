...
Built for [Hermes Agent](https://github.com/SkrrtSkerrt/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`SkrrtSkerrt/hermes-agent/skills/creative/ascii-video`](https://github.com/SkrrtSkerrt/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
