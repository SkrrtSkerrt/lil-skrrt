#!/usr/bin/env python3
"""Google Workspace API CLI for Lil Skrrt Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Lil Skrrt-facing JSON contract and falls back to the Python client
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Lil Skrrt Agent")
