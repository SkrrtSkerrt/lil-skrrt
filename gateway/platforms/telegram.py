...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. Lil Skrrt-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "To recover: ensure no other Lil Skrrt or OpenClaw instance is running "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the Lil Skrrt process (shared mount, same machine, etc.).
    ...
    async def send_update_prompt(
        ...
        try:
            ...
            text = self.format_message(f"☠︎ *Update needs your input:*\n\n{prompt}{default_hint}")
    ...
    async def _handle_callback_query(
        ...
        try:
            await query.edit_message_text(
                text=self.format_message(f"☠︎ Update prompt answered: *{label}*"),
                parse_mode=ParseMode.MARKDOWN_V2,
                reply_markup=None,
            )
        except Exception:
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Lil Skrrt bot profiles. A message like
