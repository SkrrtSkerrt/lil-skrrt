...
Connects Lil Skrrt Agent to WeChat personal accounts via Tencent's iLink Bot API.
...
class WeixinAdapter(BasePlatformAdapter):
    """Native Lil Skrrt adapter for Weixin personal accounts."""
    ...
    async def connect(self) -> bool:
        ...
        if self._group_policy != "disabled":
            logger.warning(
                ...
                "these accounts, so group messages may never reach Lil Skrrt regardless of this "
