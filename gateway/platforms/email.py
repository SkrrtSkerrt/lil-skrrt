"""
Email platform adapter for the Lil Skrrt gateway.

Allows users to interact with Lil Skrrt by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        ...
        imap.xatom(
            ...
            '"vendor" "SkrrtSkerrt" '
            '"support-email" "noreply@github.com/SkrrtSkerrt/hermes-agent")',
        )
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Lil Skrrt Agent")
