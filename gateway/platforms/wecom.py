...
def qr_scan_for_bot_info(
    *,
    ...
    try:
        req = urllib.request.Request(generate_url, headers={"User-Agent": "Lil SkrrtAgent/1.0"})
    ...
    while time.monotonic() < deadline:
        try:
            req = urllib.request.Request(query_url, headers={"User-Agent": "Lil SkrrtAgent/1.0"})
